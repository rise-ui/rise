...
impl WebRenderContext {
    ...
    pub fn update(&mut self, window_size: DeviceIntSize) {
    ...
    pub fn window_resized(&mut self, size: DeviceIntSize) {
        let window_rect = DeviceIntRect::new(TypedPoint2D::zero(), size);
...
impl webrender::ExternalImageHandler for QuickExternalImageHandler {
    ...
    fn lock(&mut self, key: ExternalImageId, channel_index: u8, rendering: ImageRendering) -> webrender::ExternalImage {
